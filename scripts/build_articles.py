...
# Keep generated article pages aligned with the live AdSense placement.
ADSENSE_HEAD = '<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5656416032906373" crossorigin="anonymous"></script><meta name="google-adsense-account" content="ca-pub-5656416032906373">'
AD_TOP = '<div class="ad-container article-ad-top" aria-label="إعلان"><ins class="adsbygoogle" style="display:block" data-ad-format="fluid" data-ad-layout-key="-fr+56+4k-d4+74" data-ad-client="ca-pub-5656416032906373" data-ad-slot="7867079394"></ins></div>'
AD_INLINE = '<div class="article-ad-slot" aria-label="إعلان"><ins class="adsbygoogle" style="display:block" data-ad-format="auto" data-full-width-responsive="true" data-ad-client="ca-pub-5656416032906373" data-ad-slot="3143411927"></ins></div>'
AD_BOTTOM = '<div class="ad-container article-ad-bottom" aria-label="إعلان"><ins class="adsbygoogle" style="display:block" data-ad-format="autorelaxed" data-ad-client="ca-pub-5656416032906373" data-ad-slot="6528123169"></ins></div>'

for generated in [ROOT / "articles.html", *sorted(OUT.glob("*.html"))]:
    html = generated.read_text(encoding="utf-8")
    if "adsbygoogle.js?client=ca-pub-5656416032906373" not in html:
        html = html.replace("</head>", ADSENSE_HEAD + "</head>", 1)
    if generated.parent == OUT and 'class="article-ad-slot"' not in html:
        html = html.replace("</figure><div class=\"article-layout\">", f"</figure>{AD_INLINE}<div class=\"article-layout\">", 1)
        html = html.replace('<div class="ad-container"><div class="ad-box">مساحة إعلانية متجاوبة</div></div>', AD_BOTTOM, 1)
    if generated.name == "articles.html":
        if 'class="article-ad-top"' not in html:
            html = html.replace("</p></div><div class=\"article-index\">", f"</p></div>{AD_TOP}<div class=\"article-index\">", 1)
